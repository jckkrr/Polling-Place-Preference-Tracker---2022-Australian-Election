...
df_g08 = select_census_data_allcols('G08')
df_g08 = df_g08[['CED_CODE_2021'] + [x for x in df_g08.columns if x.startswith('Tot')]]
df_CENSUS = df_CENSUS.merge(df_g08, on = 'CED_CODE_2021', how = 'outer')
